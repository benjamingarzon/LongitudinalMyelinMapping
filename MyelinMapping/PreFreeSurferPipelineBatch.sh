...
#  TemplateMask="${HCPPIPEDIR_Templates}/MNI152_T1_${resolution}mm_brain_mask.nii.gz" #Hires MNI brain mask template
  TemplateMask="${HCPPIPEDIR_Templates}/MNI152_T1_${resolution}mm_brain_mask_dil.nii.gz" #Hires MNI brain mask template
  ...
  #T1wSampleSpacing=`cat ${StudyFolder}/${Subject}/unprocessed/3T/T1w_MPR1/DwellTime.txt` #"0.000011999" # For General Electric scanners, 1/((0018,0095)*(0028,0010))
  #T2wSampleSpacing=`cat ${StudyFolder}/${Subject}/unprocessed/3T/T2w_SPC1/DwellTime.txt` #"0.000008000" # For General Electric scanners, 1/((0018,0095)*(0028,0010))
  #UnwarpDir="y"
  #
